		...
		<div class="pay">
			...
			<div class="list">
				<div class="item">
					<div class="itemList">
						借条类型：
						<span v-if="rowData.type ==1">个人借条</span>
						<span v-if="rowData.type ==2">小贷(金融)借条</span>
					</div>
					<div class="itemList">
						诉讼情况：
						<span v-if="rowData.lawsuitState ==1">已诉讼</span>
						<span v-if="rowData.lawsuitState ==2">未诉讼</span>
						<span v-if="rowData.lawsuitState ==3">不清楚</span>
					</div>
				</div>
				<div class="item">
					<div class="itemList">债权本息：{{rowData.amountAndInterest}}</div>
					<div class="itemList">
						转让折扣： {{rowData.rate}} 折
					</div>
				</div>
				<div class="item">
					<div class="itemList">成交金额：{{rowData.amount}}元</div>
				</div>
			</div>
			<div class="white"></div>
			<div class="content-box">
				...
				<!-- 网银支付 -->
				<div class="bank" v-if="tab2Show" style="height:310px;">
					<div class="bankTitle">支付银行：</div>
					<div class="bankLogo" style="width:800px;">
				...
				<div class="password" v-if="tab1Show">
					...
					<div class="pwdInput">
						<el-input type="password" placeholder="请输入6位数字交易密码" maxlength="6" style="height:36px;width:400px;text-indent:10px;" v-model.number="confirmBox.transPassword"></el-input>
					</div>
				</div>
				...
				<!-- 立即付款 -->
				<div class="payNow" @click="confirmCash()" v-if="clickShow" style="cursor: pointer;">立即付款</div>
				<div class="payNow" v-if="!clickShow" style="cursor: pointer;">立即付款</div>
		...
		data() {
			return {
				...
				bankCheckList: [
					...
					{
						bankCode: "01030000",
						selectedImg: require("@/assets/images/1.png"),
						img: require("@/assets/images/bank1.png"),
						isSeleted: true
					},
					{
						bankCode: "01040000",
						selectedImg: require("@/assets/images/2.png"),
						img: require("@/assets/images/bank2.png"),
						isSeleted: false
					},
					{
						bankCode: "01050000",
						selectedImg: require("@/assets/images/3.png"),
						img: require("@/assets/images/bank3.png"),
						isSeleted: false
					},
					{
						bankCode: "03030000",
						selectedImg: require("@/assets/images/4.png"),
						img: require("@/assets/images/bank4.png"),
						isSeleted: false
					},
					{
						bankCode: "03090000",
						selectedImg: require("@/assets/images/5.png"),
						img: require("@/assets/images/bank5.png"),
						isSeleted: false
					},
					{
						bankCode: "03050000",
						selectedImg: require("@/assets/images/6.png"),
						img: require("@/assets/images/bank6.png"),
						isSeleted: false
					},
					{
						bankCode: "03020000",
						selectedImg: require("@/assets/images/7.png"),
						img: require("@/assets/images/bank7.png"),
						isSeleted: false
					},
					{
						bankCode: "03060000",
						selectedImg: require("@/assets/images/8.png"),
						img: require("@/assets/images/bank8.png"),
						isSeleted: false
					},
					{
						bankCode: "03100000",
						selectedImg: require("@/assets/images/9.png"),
						img: require("@/assets/images/bank9.png"),
						isSeleted: false
					},
					{
						bankCode: "03070000",
						selectedImg: require("@/assets/images/10.png"),
						img: require("@/assets/images/bank10.png"),
						isSeleted: false
					},
					{
						bankCode: "01020000",
						selectedImg: require("@/assets/images/11.png"),
						img: require("@/assets/images/bank11.png"),
						isSeleted: false
					},
					{
						bankCode: "03080000",
						selectedImg: require("@/assets/images/12.png"),
						img: require("@/assets/images/bank12.png"),
						isSeleted: false
					},

					{
						bankCode: "04031000",
						selectedImg: require("@/assets/images/13.png"),
						img: require("@/assets/images/bank13.png"),
						isSeleted: false
					},
					{
						bankCode: "03040000",
						selectedImg: require("@/assets/images/14.png"),
						img: require("@/assets/images/bank14.png"),
						isSeleted: false
					},
					{
						bankCode: "01000000",
						selectedImg: require("@/assets/images/15.png"),
						img: require("@/assets/images/bank15.png"),
						isSeleted: false
					}
				],
		...
		methods: {
					...
					.then(res => {
						if(res.code === 200) {
							...
							this.dikoujuan.map(itm => {
								...
								var itt =
									itm.name + " " + itm.rate + "%OFF" + " (有效日期" + tien + ")";
			...
			confirmCash() {
				if(this.confirmBox.payType === 2) {
					...
					var sdid = this.rowData.id.transOrderId ?
						this.rowData.id.transOrderId :
						this.rowData.id;
					ajax({
			...
			confirmZhiFu() {
				let sourcePay =
					this.$route.query.source && this.$route.query.source === "payment";
