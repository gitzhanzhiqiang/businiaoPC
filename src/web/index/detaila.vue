<template>
	...
	<div class="detail psspd">
		...
		<div class="debtDetail">
			...
			<div class="middleCon">
				<div class="logo">
					<img v-if="detailData.logo" :src="detailData.logo" width="125" height="86" />
					<img v-if="!detailData.logo" src="~@/assets/images/moren.png" width="125" height="86" />
				</div>
				<div class="thirdStatus">
					...
					<div class="trendecya">
						<div class="link-text" @click="centerDialogVisible = true" style="color:#666666;cursor: pointer;">
		                    <div style="float: left;">分享</div>
		                    <div style="float: right;margin-top: 2px;"><img src="./img/fengxiang.png"/></div>
		                  </div>
	                  <div class="Rdiscount-text" @click="getTendency(detailData.pfName)">
	                    <div style="margin-right: 10px;float: left;"><img style="cursor: pointer;" src="~@/assets/images/discount.png" alt=""></div>
	                    <div>折扣趋势</div>
	                  </div>
				...
				<!--<div class="trendecy" v-if="detailData.rule">
					<span>债转规则</span>
					<p>{{detailData.rule}}</p>
				</div>-->
			</div>
			<div class="amountItem">
				...
				<div class="amountTop">
					...
					<div class="mainCon">
						<div class="main">
							<div class="item">
								<div class="amount">{{detailData.totalCount}}个</div>
								<div class="amounttitle">总发布数量</div>
							</div>
							<div class="item">
								<div class="amount">{{detailData.countSuccess}}个</div>
								<div class="amounttitle">总成交数量</div>
							</div>
							<div class="item">
								<div class="amount">{{(detailData.totalAmount/10000)|formatMoney}}万元</div>
								<div class="amounttitle">总转让金额</div>
							</div>
							<div class="item">
								<div class="amount">{{(detailData.avgRate)|formatMoney}}折</div>
		...
		<div class="debtdataBottom" v-if='listtype[0].isShow === true'>
            <ul class="debtdataBottom-list">
              ...
              <!-- 转让金额 -->
              <li @click="optionParams.amountSort = 0;optionParams.discountAmountSort = 0;optionParams.discountRateSort = 0;optionParams.surplusPeriodSort = 0;getApplyLista();">默认
                
              </li>
              <li v-if="optionParams.amountSort === 0" @click="optionParams.amountSort = 2;optionParams.discountAmountSort = 0;optionParams.discountRateSort = 0;optionParams.surplusPeriodSort = 0;getApplyLista();">转让金额
              ...
              <li v-if="optionParams.amountSort === 1" @click="optionParams.amountSort = 0;optionParams.discountAmountSort = 0;optionParams.discountRateSort = 0;optionParams.surplusPeriodSort = 0;getApplyLista();">转让金额
                <img src="./img/shan.png" v-if="optionParams.amountSort === 0">
              ...
              <!-- 折扣金额 -->
              <li v-if="optionParams.discountAmountSort === 0" @click="optionParams.discountAmountSort = 2;optionParams.amountSort = 0;optionParams.discountRateSort = 0;optionParams.surplusPeriodSort = 0;getApplyLista();">折扣金额
              ...
              <li  v-if="optionParams.discountAmountSort === 1" @click="optionParams.discountAmountSort = 0;optionParams.amountSort = 0;optionParams.discountRateSort = 0;optionParams.surplusPeriodSort = 0;getApplyLista();">折扣金额
                <img src="./img/shan.png" v-if="optionParams.discountAmountSort === 0">
              ...
              <!-- 转让折扣 -->
              <li  v-if="optionParams.discountRateSort === 0" @click="optionParams.discountRateSort = 2;optionParams.amountSort = 0;optionParams.discountAmountSort = 0;optionParams.surplusPeriodSort = 0;getApplyLista();">转让折扣
              ...
              <li  v-if="optionParams.discountRateSort === 1" @click="optionParams.discountRateSort = 0;optionParams.amountSort = 0;optionParams.discountAmountSort = 0;optionParams.surplusPeriodSort = 0;getApplyLista();">转让折扣
                <img src="./img/shan.png" v-if="optionParams.discountRateSort === 0">
              ...
              <!-- 剩余期限 -->
              <li v-if="optionParams.surplusPeriodSort === 0" @click="optionParams.surplusPeriodSort = 2;optionParams.discountRateSort = 0;optionParams.amountSort = 0;optionParams.discountAmountSort = 0;getApplyLista();">剩余期限
              ...
              <li v-if="optionParams.surplusPeriodSort === 1" @click="optionParams.surplusPeriodSort = 0;optionParams.discountRateSort = 0;optionParams.amountSort = 0;optionParams.discountAmountSort = 0;getApplyLista();">剩余期限
                <img src="./img/shan.png" v-if="optionParams.surplusPeriodSort === 0">
          ...
          <ul class="datalist-specific" v-if="allData.length && listtype[0].isShow === true" style="min-height:100px;">
            ...
            <div class="datalist-specificR">
              ...
              <div class="datalist-specificR-context">
                <div class="datalist-specificR-context-item">
                  <i style="color:rgba(51,51,51,1);font-size: 16px">{{item.amount}}</i>元<br>转让金额
                </div>
                <div class="datalist-specificR-context-item">
                  <i style="color: #FF0000;font-size: 16px">{{item.discountRate}}</i>折 <br>转让折扣
                </div>
                <div class="datalist-specificR-context-item">
                  <i style="color: #FF0000">{{item.discountAmount}}</i>元 <br>折扣金额
                </div>
                <div class="datalist-specificR-context-item">
                  <span>
                    <i style="color:rgba(51,51,51,1);">{{item.annualRate}}%</i><br>历史年化
                  </span>
                </div>
                <div class="datalist-specificR-context-item">
